...
class ZakatLoginView extends StatefulWidget {
  const ZakatLoginView({Key? key}) : super(key: key);

  Widget build(context, ZakatLoginController controller) {
                ...
                decoration: const BoxDecoration(
                  image: DecorationImage(
                    image: NetworkImage(
                        ...
                        "https://images.unsplash.com/photo-1578895151671-7d2e2e89dcf7?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=435&q=80"),
                    fit: BoxFit.cover,
                  ),
                ),
              ),
  ...
  @override
  State<ZakatLoginView> createState() => ZakatLoginController();
}
